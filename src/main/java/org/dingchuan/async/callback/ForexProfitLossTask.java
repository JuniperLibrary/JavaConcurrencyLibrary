...
public class ForexProfitLossTask implements Callable<BigDecimal> {
  ...
  public ForexProfitLossTask(BigDecimal holdingAmount, BigDecimal openingRate, BigDecimal closingRate,
      ProfitLossCallback callback) {
